...
**Note**: You need to use `git push -u origin master` for the next commit only. After that just use `git push`, although I believe you could do `git push origin master` and it won't have a negative effect.
